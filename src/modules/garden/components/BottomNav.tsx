        ...
        {ITEMS.map(item => {
          ...
          return (
            ...
            >
              ...
              <div style={{ color: active ? 'var(--acc)' : 'var(--t3)', transition: 'color 0.2s', position: 'relative', zIndex: 1 }}>
                <Icon size={22} strokeWidth={active ? 2.5 : 2} />
              </div>
              <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.04em', color: active ? 'var(--acc)' : 'var(--t3)', position: 'relative', zIndex: 1 }}>
                {item.label}
              </span>
            </button>
          );
